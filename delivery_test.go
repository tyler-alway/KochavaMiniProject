...
var urlTests = []fmturltestpair{
	...
	{data: postback{Method: "GET", Url: "https://httpbin.org/get?evil={other}", Data: map[string]string{"other": "/ ? & $ # @ { } ( )"}}, result: "https://httpbin.org/get?evil=%2F+%3F+%26+%24+%23+%40+%7B+%7D+%28+%29"},                           //check urlencoding
